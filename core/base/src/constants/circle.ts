import { MapLevel, MapLevels, zip, constMap } from "../utils";
...
const circleDomains = [
  ...
  [5, "Solana"   ],
  [6, "Base"     ],
] as const satisfies MapLevel<number, Chain>;
...
export const [circleChainIds, circleChains] = zip(circleDomains);
...
export const circleChainId = constMap(circleDomains, [1, 0]);
export const circleChainIdToChain = constMap(circleDomains);
