...
export type DefinedOrDefault<T, D> = undefined extends T
  ? D
  : Exclude<T, undefined>;
...
export type And<
  T extends RoArray<boolean> | boolean,
...
export type IsUnionMember<T, U> = And<
  [Extends<T, U>, IsUnion<U>, Not<IsUnion<T>>, Not<IsNever<T>>, Not<IsAny<T>>]
>;

export type ConcatStringLiterals<A extends RoArray<string>> =
  A extends readonly [
    infer S extends string,
    ...infer Tail extends RoArray<string>
  ]
