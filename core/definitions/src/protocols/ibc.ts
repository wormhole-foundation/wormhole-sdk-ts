...
import { AccountAddress, TokenAddress, ChainAddress, NativeAddress } from "../address";
...
export interface IbcBridge<P extends Platform, C extends Chain = PlatformToChains<P>> {
