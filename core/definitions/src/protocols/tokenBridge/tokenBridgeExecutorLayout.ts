...
export const tokenBridgeExecutorNamedPayloads = [
  ...
  export namespace WormholeRegistry {
    interface PayloadLiteralToLayoutMapping
      extends RegisterPayloadTypes<
        "TokenBridgeExecutor",
        typeof tokenBridgeExecutorNamedPayloads
      > {}
  }
}

registerPayloadTypes("TokenBridgeExecutor", tokenBridgeExecutorNamedPayloads);
