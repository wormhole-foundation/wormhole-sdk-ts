...
import { blindDeserializePayload, deserialize, deserializePayload, loldeserialize } from "../src/index.js"
...
describe("Blind Deserialize", function () {
    it("Should deserialize a blind message", function () {
        ...
        console.log(deserializePayload("TokenBridge:Transfer", vaa.payload))
        console.time("blind")
        const blind = blindDeserializePayload(vaa.payload)
        console.timeEnd("blind")
        console.log(blind)
        console.time("lol")
        const lol = loldeserialize(vaa.payload)
        console.timeEnd("lol")
        console.log(lol)
