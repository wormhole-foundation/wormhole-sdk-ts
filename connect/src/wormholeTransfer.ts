...
interface SourceInitiatedTransferReceipt<
...
interface SourceFinalizedTransferReceipt<
  PN extends ProtocolName,
  SC extends Chain,
  DC extends Chain,
...
interface AttestedTransferReceipt<PN extends ProtocolName, SC extends Chain, DC extends Chain>
  extends SourceFinalizedTransferReceipt<PN, SC, DC> {
  attestation: Required<AttestationReceipt<PN>>;
}
interface CompletedTransferReceipt<PN extends ProtocolName, SC extends Chain, DC extends Chain>
